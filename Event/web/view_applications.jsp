...
{ 
 ...
 if(request.getParameter("delete")!=null)
 {
  ...
  pstmt=con.prepareStatement("UPDATE `application` SET `status` = 'Approved' WHERE `application`.`id` =? "); //sql delete query
  pstmt.setInt(1,id);
...
<body bgcolor="#33ffdd">
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-6">
                <div class="card-heading">
                    ...
                    <h2 class="title"><h1>Total Applications</h1></h2>
                </div>
                <div class="card-body">
                    <form method="POST">
  ...
  { 
   ...
   pstmt=con.prepareStatement("select * from application"); //sql select query 
  ...
  %>
    <tr>
     ...
     <td><a href="?delete=<%=rs.getInt(2)%> ">Approve</a></td>
    </tr>
  <%
   }
